...
import MfaDisable from '@/src/components/mfa/MfaDisable';
...
export default function ProfilePage() {
  ...
  return (
    <>
      {/* MFA Setup modal — rendered outside page flow so it overlays everything */}
      {showMfaSetup && (
        <MfaSetup
          onComplete={() => {
            setMfaEnabled(true);
        ...
        <div className={styles.profileContent}>
          ...
          {!isEditing && (
            <section className={`${styles.section} ${styles.securitySection}`}>
              ...
              {mfaLoading ? (
                <p className={styles.mfaLoading}>Loading security settings…</p>
              ) : mfaEnabled ? (
                <MfaDisable
                  onDisabled={() => setMfaEnabled(false)}
                  onCancel={() => {/* panel handles its own cancel state */}}
                />
              ) : (
                <div className={styles.mfaOff}>
                  <div className={styles.mfaOffRow}>
                    <div>
                      <p className={styles.mfaOffTitle}>Two-factor authentication is <strong>off</strong></p>
                      <p className={styles.mfaOffDesc}>Add a second layer of security to your account using an authenticator app.</p>
                    </div>
                    <button
                      type="button"
                      className={styles.enableMfaBtn}
